		...
		<div class="navbar-menu-wrapper d-flex align-items-top"> 
			<ul class="navbar-nav">
				<li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
					<h1 class="welcome-text">Bem vindo! <span class="text-black fw-bold"></span></h1>
					<h3 class="welcome-sub-text">Performence da Smarth Health</h3>
				</li>
			</ul>
			<ul class="navbar-nav ms-auto">
				<li class="nav-item dropdown d-none d-lg-block">
					...
					<button class="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-bs-toggle="offcanvas"class="nav-link" href="logout.php" >
											...
											<ul class="nav nav-tabs" role="tablist">
												<div>
													<div class="btn-wrapper">
														<a href="#" class="btn btn-otline-dark align-items-center"><i class="icon-share"></i> Partilhar</a>
													...
													<div class="card card-rounded">
														<div class="card-body card-rounded">
															...
															<div class="list align-items-center pt-3">
																<div class="wrapper w-100">
																	<p class="mb-0">
																		<a href="#" class="fw-bold text-primary">Mostrar Mais <i class="mdi mdi-arrow-right ms-2"></i></a>
																	</p>
																</div>
															</div>
														</div>
