				...
				<div class="content-wrapper">
					<div class="row">
						...
						<div class="col-lg-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Sensor de Humidade</h4>
									<p class="card-description">
										Registos do sensor de humidade, acionado de 30 em 30 min.
									</p>
									<div class="table-responsive">
										<table class="table">
											<thead>
						...
						<div class="col-lg-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Sensor de fumo</h4>
									<p class="card-description">
										Registos do sensor de fumo, acionado apenas quando deteta fumo.
									</p>
									<div class="table-responsive">
						...
						<div class="col-lg-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Sensor abertura de portas</h4>
									<p class="card-description">
										Registos do sensor que controla a abertura das portas do hospital.
									</p>
									<div class="table-responsive">
										<table class="table">
											<thead>
